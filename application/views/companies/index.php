        ...
        <div class="w-full flex gap-6 h-full mb-3">
            <div class="w-1/4 sticky top-0">
                <div class="bg-white rounded-lg h-full overflow-y-auto no-scrollbar mb-4 p-4 dark:bg-gray-800 dark:text-white">
                    ...
                    <h4 class="text-lg font-medium mt-4">Secteurs d'activité</h4>
                    <div class="w-full max-w-xs mx-auto mt-5 text-black">
                        ...
                        <select id="secteursAll" name="secteursAll[]" multiple class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white text-black rounded-full shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <?php foreach ($secteursAll as $secteur): ?>
                                <option class="text-black" value="<?= $secteur['secteurId'] ?>">
            ...
            <div class="w-3/4 overflow-y-auto no-scrollbar">
                ...
                <div class="flex flex-wrap" id="companies-section">
                            ...
                            <div class="bg-white rounded-lg h-20vh mt-4 p-4 dark:bg-gray-800 dark:text-white relative company-item" data-company-name="<?=strtolower($company->companyName)?>" data-company-localisation="<?=$company->companyLocalisation?>" data-company-secteur="<?=$company->secteurId?>">
                                <div class="flex items-center">
                                    ...
                                    <div class="w-3/4 mr-4">
                                        <h2 class="font-bold text-lg"><?=$company->companyName?></h2>
                                        <p>
                    ...
                    <div id="no-company-found">
                        <p class="text-xl mt-6 text-left">Aucune entreprise n'a été trouvée.</p>
                        <h3 class="text-2xl font-medium mt-10" id="result-section">Autres entreprises :</h3>
                        <?php foreach($companies as $company): ?>
                            <a href="<?=base_url('user/companyView/'.$company->idCompany)?>" 
                                class="" > 
