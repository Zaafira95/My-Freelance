                ...
                <div class="w-full lg:w-3/4 relative grid-cols-2 bg-white rounded-lg mb-4 dark:bg-gray-800 py-4 px-4 overflow-y-auto no-scrollbaroverflow-y-auto no-scrollbar">
                    ...
                    <form id="missionForm" action="<?=base_url("company/addMission")?>" method="post" enctype="multipart/form-data">
                        <div class="flex flex-1 mt-4">
                            ...
                            <input type="number" name="missionTJM" placeholder="TJM €" min="100" class="text-3xl lg:text-base block mb-4 border mt-2 border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required/>
                        </div>
                        ...
                        <div class="flex flex-1 mt-4">
                            <input type="text" name="missionLocation" id="citySearch" placeholder="Cherchez votre ville" class="text-3xl lg:text-base border p-2 rounded-lg w-full text-black">
                            ...
                            <div class="flex mb-4">
                                <div class="flex flex-col w-full mr-4">
                                    <label for="missionDateDebut" class="text-3xl lg:text-base w-full block mt-4 mb-2 font-medium text-gray-900 dark:text-white">Date de début</label>
                                ...
                                <div class="flex flex-col w-full">
                                    <label for="missionDateFin" class="text-3xl lg:text-base w-full block mt-4 mb-2 font-medium text-gray-900 dark:text-white">Date de fin</label>
                        ...
                        <div class="flex flex-1 mt-4">
                            <button type="submit" class="text-3xl lg:text-base bg-primary hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Poster la mission</button>
                        </div>
