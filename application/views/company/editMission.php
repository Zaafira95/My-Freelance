...
<div id="deleteMission" tabindex="-1" aria-hidden="true" class=" hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <p class="text-2xl lg:text-base text-gray-700 dark:text-white mb-6">Êtes-vous sûr de vouloir supprimer cette mission ?</p>
            <div class="flex justify-end">
                <button type="button" data-modal-toggle="deleteMission" class="text-2xl lg:text-base text-gray-600 inline-flex items-center hover:text-white hover:bg-gray-800 border-gray-600  focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg px-5 py-2.5 text-center dark:border-gray-500 dark:text-gray-500  dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-900">
                    Annuler
                </button>
            ...
            <div class="w-full flex gap-6 h-full mb-3">
                <div class="w-full lg:w-3/4 relative grid-cols-2 bg-white rounded-lg mb-4 dark:bg-gray-800 py-4 px-4 overflow-y-auto no-scrollbaroverflow-y-auto no-scrollbar">
                    ...
                    <form id="missionForm" action="<?=base_url("company/editMission/".$mission->idMission)?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-1 mt-4">
                            <input type="text" name="missionLocation" id="citySearch" value="<?= $mission->missionLocalisation ?>" placeholder="Cherchez votre ville" class="text-2xl lg:text-base border p-2 rounded-lg w-full text-black">
                            ...
                            <div class="flex flex-1 mt-4">
                                <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700 w-full mr-4">
                                    ...
                                    <label for="courte" class="text-2xl lg:text-base py-4 ml-2  font-medium text-gray-900 dark:text-white">Courte Durée</label>
                                </div>
                                <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700 w-full mr-4">
                                    ...
                                    <label for="longue" class="text-2xl lg:text-base py-4 ml-2  font-medium text-gray-900 dark:text-white">Longue Durée</label>
                                </div>
                                <div class="flex items-center pl-4 border  border-gray-200 rounded dark:border-gray-700 w-full mr-4">
                                    <input type="radio" id="indefinie" value="indefinie" name="missionDuration" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php echo ($mission->missionDuration === 'indefinie') ? 'checked' : ''; ?>>
                                    <label for="indefinie" class="text-2xl lg:text-base py-4 ml-2  font-medium text-gray-900 dark:text-white">Durée indéfinie</label>
                                </div>
                            </div>
                                
                            <div class="flex mb-4">
                                <div class="flex flex-col w-full mr-4">
                                    <label for="missionDateDebut" class="text-2xl lg:text-base block mt-4 mb-2 font-medium text-gray-900 dark:text-white">Date de début</label>
                                    <input type="date" id="missionDateDebut" name="missionDateDebut" value="<?= $mission->missionDateDebut ?>" class="text-2xl lg:text-base w-full bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                </div>

                                <div class="flex flex-col w-full">
                                    <label for="missionDateFin" class="text-2xl lg:text-base block mt-4 mb-2 font-medium text-gray-900 dark:text-white">Date de fin</label>
                                    <input type="date" id="missionDateFin" name="missionDateFin" value="<?= $mission->missionDateFin ?>" class="text-2xl lg:text-base w-full bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            <div class="flex flex-1">
                                <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700 w-full mr-4">
                                    ...
                                    <label for="temps-plein" class="text-2xl lg:text-base py-4 ml-2  font-medium text-gray-900 dark:text-white">Temps plein</label>
                                </div>
                                <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700 w-full mr-4">
                                    ...
                                    <label for="temps-partiel" class="text-2xl lg:text-base py-4 ml-2  font-medium text-gray-900 dark:text-white">Temps partiel</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="missionExperience" name="missionExperience" class="text-2xl lg:text-base w-full block mr-3 mb-4 border mt-2 border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                <?php
                        ...
                        <div id="skills-container">
                            <p class="text-3xl lg:text-lg font-bold mt-4 mb-4"> Compétences requises </p>
                        ...
                        <div class="mt-4">
                            <div class="flex flex-1">
                                ...
                                <div class="flex items-center pl-4 border  border-gray-200 rounded dark:border-gray-700 w-full mr-4">
                                    ...
                                    <label for="sur-site" class="text-2xl lg:text-base py-4 ml-2  font-medium text-gray-900 dark:text-white">Sur site</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            <div id="editor" class="text-2xl lg:text-base block  mb-4 border mt-2 border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                -->
                                <div class="ql-editor text-2xl lg:text-base"><?= $mission->missionDescription ?></div>
                            </div>
                        </div>
                        <textarea id="missionDescription" name="missionDescription" placeholder="Description de la mission" cols="20" rows="5" class="text-2xl lg:text-base hidden block  mb-4 border mt-2 border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                        ...
                        <div class="mt-4">
                            <div id="editor2" class="text-2xl lg:text-base block mb-4 border mt-2 border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <div class="ql-editor text-2xl lg:text-base"><?= $mission->missionAvantage ?></div>
                            </div>
                        </div>
                        <textarea id="missionAvantages" name="missionAvantages" placeholder="Description de la mission" cols="20" rows="5" class="text-2xl lg:text-base hidden block  mb-4 border mt-2 border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
