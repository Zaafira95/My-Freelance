                ...
                <div class="hidden lg:block bg-white rounded-lg lg:h-full overflow-y-auto no-scrollbar lg:no-shadow shadow-lg mb-8 lg:mb-4 p-4 dark:bg-gray-800 dark:text-white" id="FilterMission">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="checkbox" class="w-6 h-6 lg:w-3 lg:h-3 form-checkbox mr-2" id="unavailable">
                            <span class="ml-2 text-3xl lg:text-base">Unavailable</span>
                        </label>
                    </div>
                        ...
                        <a href="<?=base_url('company/freelancerView/'.$freelancer->userId)?>" 
                            ...
                            data-freelancer-skills="<?= implode(',', $freelancerSkillsArray) ?>">
                                ...
                                <div class="skills-container mb-4">
                                    ...
                                    ?>
                                    <!-- Limiter l'affichage des compétences à 6 -->
                        ...
                        <div class="bg-white rounded-lg h-22vh p-4 dark:bg-gray-800 dark:text-white">
                            ...
                            <a class="flex flex-col items-center" href="<?=base_url('company/my_company')?>">
                                <div class="w-20 h-20 rounded-full border-10 ring-2 ring-primary overflow-hidden">
                                    ...
                                    ?>
                                    <img src="<?php echo base_url($company->companyLogoPath); ?>" alt="Avatar" class="object-cover w-20 h-20 p-0.5 rounded-full ring-2 ring-primary">
                                </div>
                                ...
                                <a href="<?php echo base_url('company/my_company');?>" class="text-primary mt-2 px-4 py-1 rounded-full">Edit my company</a>
                                <a href="<?php echo base_url('Company/missionAdd');?>" class="mt-2  px-4 py-1 rounded-full hover:bg-primary-900 bg-primary-700 text-white">Add a mission</a>
                                <a href="<?php echo base_url('Company/logout');?>" class="text-red-800 mt-2 hover:text-red-900">Logout</a>
    
                            </div>
                        </div>

                        <div class="bg-white rounded-lg mt-4 p-4 text-left dark:bg-gray-800 dark:text-white">
                            <h3 class="text-xl font-medium mt-2">Your job offers</h3>
                            <?php if (is_array($job_for_company) && !empty($job_for_company)) {
                                ...
                                ?>
                                    <a href="<?= base_url('company/missionView/' . $job->idMission) ?>" class="flex items-center">
                                        <div class="w-full flex items-center mt-2 mb-2 p-2 rounded-lg shadow">
                                            <div class="mr-2 mt-2">
                                                <div class="w-10 h-10" style="font-size:1rem;">
                                                    <img src="<?=base_url($company->companyLogoPath)?>" class="w-10 h-10 rounded-full flex items-center justify-center" alt="Company logo">
                                                </div>
                                            </div>
                                            <div>
                                ...
                                ?>
                            <?php } else { ?>
                                <p class="mt-2 mb-2"> No missions available. </p>
