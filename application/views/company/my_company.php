...
<!--Company Data modal -->
<div id="updateCompanyData" tabindex="-1" aria-hidden="true" class=" hidden overflow-y-auto overflow-x-hidden fixed top-30 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="<?=base_url("company/updateCompanyData")?>" method="post" enctype="multipart/form-data">
                <div class="bg-white dark:bg-gray-800 relative rounded-lg w-full h-auto mb-4">
                ...
                <div>
                    ...
                    <div class="relative city-search-container w-full mb-1">
                        <input type="text" id="citySearch" name="companyLocalisation" value="<?php echo $company->companyLocalisation != 'Etranger' ? $company->companyLocalisation : "" ?>" placeholder="Cherchez votre ville" class="border p-2 rounded-lg w-full text-black">
