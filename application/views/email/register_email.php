<html>
<head>
    <title> Activation de votre compte My Freelance </title>
...
<div style="background-color:#FFFFFF;margin:0px auto;max-width:800px; padding:2rem; margin-left:auto; margin-right:auto;">
    ...
    <div style="max-width:600px;margin-left:auto; margin-right:auto;">
        ...
        <h1 style="font-size: 24px; font-weight: 600; color: #000000; margin-top: 20px; margin-bottom: 20px; padding: 0; text-align: left;">Activation de votre compte My Freelance
</h1>

        <!-- Activate your account text -->
        <p style="font-size: 16px; font-weight: 400; color: #000000; margin: 0; padding: 0; text-align: left;">Bonjour, vous venez de créer un compte sur My Freelance. Pour activer votre compte, veuillez cliquer sur le lien ci-dessous.</p>
