...
<div style="background-color:#FFFFFF;margin:0px auto;max-width:800px; padding:2rem; margin-left:auto; margin-right:auto;">
    ...
    <div style="max-width:600px;margin-left:auto; margin-right:auto;">
        ...
        <p style="font-size: 14px; font-weight: 400; color: #000000; margin-top: 20px; padding: 0; text-align: left;">Hello <?php echo $companyName?>, nous sommes ravis de vous accueillir parmi nous !</p>
        
        <p style="font-size: 14px; font-weight: 400; color: #000000; margin-top: 20px; padding: 0; text-align: left;">Prêt à propulser le potentiel de votre entreprise ? Découvrez nos talents IT, et trouvez les compétences qui feront la différence pour vos projets 🚀</p>
