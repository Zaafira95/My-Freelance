            ...
            <div class="flex items-center lg:order-2">
                ...
                <div class="relative">
                    ...
                    <div id="dropdown" class=" absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md overflow-hidden shadow-xl z-10 hidden">
                        ...
                        <a href="<?php echo base_url('admin/banner');?>" class="flex items-center space-x-2 block rounded-md px-4 py-4 text-gray-400 dark:text-gray-400 hover:bg-secondary dark:hover:text-white hover:text-gray-900 dark:hover:bg-primary">
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        ...
                        ?>
                            <a href="<?php echo base_url('user/mission');?>" class="block py-2 pr-4 pl-3 text-primary bg-primary lg:bg-transparent lg:text-primary lg:p-0 border-b-2 border-primary dark:text-white">Freelances</a>
                        <?php
                            } else {
                        ?>
                            <a href="<?php echo base_url('user/mission');?>" class="block py-2 pr-4 pl-3 text-black border-b lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-400 lg:p-0 dark:text-white">Freelances</a>
                        <?php
                            }
                        ?>
                    </li>
                    <li>
                        ...
                        ?>
                            <a href="<?php echo base_url('user/profil');?>" class="block py-2 pr-4 pl-3 text-primary bg-primary lg:bg-transparent lg:text-primary lg:p-0 border-b-2 border-primary dark:text-white">Missions</a>
                        <?php
                            } else {
                        ?>
                            <a href="<?php echo base_url('user/profil');?>" class="block py-2 pr-4 pl-3 text-black border-b lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-400 lg:p-0 dark:text-white">Missions</a>
                        <?php
                            }
                        ?>
                    </li>
                    <li>
                        ...
                        ?>
                            <a href="<?php echo base_url('user/whatsapp');?>" class="block py-2 pr-4 pl-3 text-primary bg-primary lg:bg-transparent lg:text-primary lg:p-0 border-b-2 border-primary dark:text-white">Entreprises</a>
                        <?php
                            } else {
                        ?>
                            <a href="<?php echo base_url('user/whatsapp');?>" class="block py-2 pr-4 pl-3 text-black border-b lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-400 lg:p-0 dark:text-white">Entreprises</a>
                        <?php
                            }
                        ?>
                    </li>
                    <li>
                        ...
                        ?>
                            <a href="<?php echo base_url('user/settings');?>" class="block py-2 pr-4 pl-3 text-primary bg-primary lg:bg-transparent lg:text-primary lg:p-0 border-b-2 border-primary dark:text-white">Communauté</a>
                        <?php
                            } else {
                        ?>
                            <a href="<?php echo base_url('user/settings');?>" class="block py-2 pr-4 pl-3 text-black border-b lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-400 lg:p-0 dark:text-white">Communauté</a>
                        <?php
                            }
                        ?>
                    </li>
