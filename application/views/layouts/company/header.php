            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        ...
                        ?>
                            <a href="<?php echo base_url('company/freelancer');?>" class="text-3xl lg:text-base block py-2 pr-4 pl-3 text-primary  border-b lg:bg-transparent lg:text-primary lg:p-0 lg:border-b-2 border-primary dark:text-primary">Freelances</a>
                        <?php
                            } else {
                        ?>
