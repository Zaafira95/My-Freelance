        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
                ...
                <div class="relative">
                    ...
                    <img src="<?php echo base_url($company->companyLogoPath); ?>" alt="Avatar" class="object-cover w-16 h-16 lg:w-8 lg:h-8 rounded-full ring-2 ring-primary">
                    </div>
                    <!-- Dropdown Menu -->
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        ...
                        ?>
                            <a href="<?php echo base_url('company/freelancer');?>" class="text-3xl lg:text-base block py-2 pr-4 pl-3 text-primary  lg:bg-transparent lg:text-primary lg:p-0 border-b-2 border-primary dark:text-white">Freelances</a>
                        <?php
                            } else {
                        ?>
                            <a href="<?php echo base_url('company/freelancer');?>" class="text-3xl lg:text-base block py-2 pr-4 pl-3 text-black border-b lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-400 lg:p-0 dark:text-white">Freelances</a>
                        <?php
                            }
                        ?>
                    </li>
                    <li>
                        ...
                        ?>
                            <a href="<?php echo base_url('company/my_company');?>" class="text-3xl lg:text-base block py-2 pr-4 pl-3 text-primary  lg:bg-transparent lg:text-primary lg:p-0 border-b-2 border-primary dark:text-white">Mon entreprise</a>
                        <?php
                            } else {
                        ?>
                    ...
                    <li>
                        ...
                        ?>
                            <a href="<?php echo base_url('company/whatsapp');?>" class="text-3xl lg:text-base block py-2 pr-4 pl-3 text-primary  lg:bg-transparent lg:text-primary lg:p-0 border-b-2 border-primary dark:text-white">Communauté</a>
                        <?php
                            } else {
                        ?>
                    ...
                    <li>
                        ...
                        ?>
                            <a href="<?php echo base_url('company/settings');?>" class="text-3xl lg:text-base block py-2 pr-4 pl-3 text-primary  lg:bg-transparent lg:text-primary lg:p-0 border-b-2 border-primary dark:text-white">Paramètres</a>
                        <?php
                            } else {
                        ?>
