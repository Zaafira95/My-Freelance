                    ...
                    <div class="flex flex-col justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                            ...
                            <div class="w-full bg-white rounded-lg shadow md:mt-0 xl:p-0 dark:bg-gray-800 dark:text-white py-12 lg:py-1 overflow-y-auto no-scrollbar">
                                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                    ...
                                    <div class="relative secteur-search-container w-full">
                                        <input type="text" id="secteurSearch" name="companySecteur" placeholder="Sélectionnez votre secteur d'activité" class="text-3xl lg:text-base bg-gray-50 border border-gray-300 text-gray-900 sm:text-lg rounded-lg block w-full p-2.5 placeholder-gray-500 focus:ring-primary-500 focus:border-primary-500">
                                            <div id="secteurs-list" class="text-3xl lg:text-base absolute z-10 mt-2 w-full rounded bg-white max-h-64 overflow-y-auto text-black"></div>
                                    </div>
                            ...
                            <div class="w-full bg-white rounded-lg shadow md:mt-0 xl:p-0 dark:bg-gray-800 dark:text-white py-12 lg:py-1 overflow-y-auto no-scrollbar">
                                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <!-- button for next step -->
                                        <button type="button" class="text-3xl lg:text-base w-1/2 ml-2 text-white bg-primary hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center" id="nextButton" onclick="goToStep6_freelance()">Suivant</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-full bg-white rounded-lg shadow  dark:bg-gray-800 dark:text-white py-12 lg:py-1 overflow-y-auto no-scrollbar">
                                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <textarea id="companyDescription" name="companyDescription" rows="2" class="text-3xl lg:text-base bg-gray-50 border border-gray-300 text-gray-500  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div>
                                            <textarea id="companyAvantages" name="companyAvantages" rows="2" class="text-3xl lg:text-base bg-gray-50 border border-gray-300 text-gray-500  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                                        </div>
                                    </div>                
                                    <div class="relative rounded-lg flex flex-wrap mb-4">
                                        <label for="companyPhotos" class="text-3xl lg:text-base block mb-2 font-medium text-gray-900 dark:text-white">Photos de votre entreprise</label>
                                        <!--
                                    ...
                                    <p id="errorMessage-step5-esn" class="text-3xl lg:text-base text-red-500  mt-2 hidden">Veuillez remplir tous les champs correctement</p>
                                    <div class="flex justify-between">
                                        <!-- button for previous step -->
                                        <button type="button" class="text-3xl lg:text-base w-1/2 mr-2 text-primary border border-primary hover:text-white hover:bg-primary focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center" id="previousButton" onclick="goToStep4_esn()">Retour</button>
                                        <!-- button for next step -->
                                        <button type="button" class="text-3xl lg:text-base w-1/2 ml-2 text-white bg-primary hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg  px-5 py-2.5 text-center" id="nextButton" onclick="goToStep6_esn()">Suivant</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:text-white">
                            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <!-- submit -->                                        
                                    <div class="flex justify-between">
                                        <button type="button" class="text-3xl lg:text-base w-1/2 mr-2 text-primary border border-primary hover:text-white hover:bg-primary focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center" id="previousButton" onclick="goToStep5()">Retour</button>
                                        <button type="submit" class="text-3xl lg:text-base w-1/2 ml-2 text-white bg-primary hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center" id="submitButton">S'inscrire</button>
                                    </div>
                                </div>
                            </div>
                        </div>
