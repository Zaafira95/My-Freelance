...
<body>
                                ...
                                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                    ...
                                    <div class="block-container flex flex-col items-center">
                                        <ul class="w-full">
                                            ...
                                            <li class="h-auto lg:h-40 p-2 w-full flex flex-col items-center overflow-hidden">
                                                <input type="radio" id="userTypeESN" name="userType" value="sales" class="hidden peer" required>
                                                <label for="userTypeESN" class="overflow-hidden h-full inline-flex flex-col items-center justify-center w-full pt-5 text-black bg-white border hover:bg-primary border-black rounded-lg cursor-pointer dark:hover:bg-primary dark:border-white dark:peer-checked:text-blue-500 peer-checked:bg-primary peer-checked:text-white hover:text-gray-600 dark:text-gray-400 dark:bg-gray-800 mb-4" onclick="handleClick(this)" onmouseover="changeTextColor(this, true)" onmouseout="changeTextColor(this, false)">
                                                    <div class="flex flex-col items-center">
    ...
    var inputFreelance = document.querySelector("#userTelephone");
    

    var itiFreelance = window.intlTelInput(inputFreelance, {
        preferredCountries: ['us', 'fr', 'ae'],
        utilsScript: base_url + "node_modules/intl-tel-input/build/js/utils.js"
    });

    function checkFreelancePhoneNumber() {

        console.log("Début de la vérification du numéro de téléphone");
        var errorMap = ["Numéro invalide", "Code de pays invalide", "Trop court", "Trop long", "Numéro invalide"];

                
        if (itiFreelance.isValidNumber()) {
            
            var phoneNumber = itiFreelance.getNumber();
            inputFreelance.value = phoneNumber;
            console.log(phoneNumber);
            console.log("inputFreelance : ", inputFreelance.value);
            console.log("Numéro de téléphone valide");


            var userTelephone2 = document.getElementById('userTelephone2');
            userTelephone2.value = phoneNumber;
            console.log("userTelephone2 : ", userTelephone2.value);
            return true;
        } else {
            var errorCode = itiFreelance.getValidationError();
            return false;
    ...
    var inputCompany = document.querySelector("#companyUserTelephone");
    ...
    function checkCompanyPhoneNumber() {
        ...
        if (itiCompany.isValidNumber()) {
            ...
            var phoneNumber = itiCompany.getNumber();
            inputCompany.value = phoneNumber;
            console.log(phoneNumber);
            console.log("inputCompany : ", inputCompany.value);
            console.log("Numéro de téléphone valide");


            var companyUserTelephone2 = document.getElementById('companyUserTelephone2');
            companyUserTelephone2.value = phoneNumber;
            console.log("companyUserTelephone2 : ", companyUserTelephone2.value);
            return true;
        } else {
    ...
    function handleClick(element) {
        ...
        function goToStep4_freelance() {
            ...
            if (userFirstName.trim() === '' || userLastName.trim() === '' || (userVille.trim() === '' && !userEtranger.checked) || !checkFreelancePhoneNumber()) {
        ...
        function goToStep4_esn() {
            ...
            if (companyUserFirstName.trim() === '' || companyUserLastName.trim() === '' || companyUserTelephone.trim() === '' || !checkCompanyPhoneNumber())
            {
                errorMessageStep3.style.display = 'block';
            } else {
                errorMessageStep3.style.display = 'none';
