...
?>
    ...
    <div id="updateUserExperienceSkills<?=$index?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            <!-- Modal content -->
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                <!-- Modal header -->
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg  p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="updateUserExperienceSkills<?=$index?>">
                        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        <span class="sr-only">Fermer</span>
                    </button>
                </div>
                <!-- Modal body -->
                <form action="<?=base_url("user/updateUserExperienceSkills/".$experience->idExperience)?>" method="post" enctype="multipart/form-data">
                    <div class="p-4 bg-white rounded-lg dark:bg-gray-800 text-black">
                        ...
                        <button id="add-experience-skill-btn" type="button" class="py-2 px-4 bg-primary text-white rounded-lg">Ajouter une compétence</button>
                    </div>
                    <!-- Rest of the form fields for the experience -->
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <div>
                            ...
                            <button type="button" data-modal-toggle="updateUserExperienceSkills<?=$index?>" class="text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg  px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                                Annuler
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="relative bg-white rounded-lg mb-4 p-4 dark:bg-gray-800 dark:text-white">
                                ...
                                ?>
                                            <div class="mb-4 mt-4">
                                                ...
                                                <div class="ml-auto mr-4">
                                                        <button id="updateUserExperienceSkills<?=$index?>" data-modal-toggle="updateUserExperienceSkills<?=$index?>" class="py-2.5 px-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" type="button">
                                                            <i class="fas fa-pen fa-fw"></i>
                                                        </button>
                                                    </div>
                                                </div> 
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#add-experience-skill-btn').on('click', function() {
            ...
            `;
            $('#experience-skills-container').append(newSkillRow2);
            // Désinitialiser les instances Choices existantes
            $('.new-skill-select').each(function() {
                const choicesInstance = this.choices;
                if (choicesInstance) {
